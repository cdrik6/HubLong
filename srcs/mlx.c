...
/*   Updated: 2024/02/14 20:17:19 by caguillo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	move(t_game *game, int i, int j, void *xpm)
{
	
	(*game).player.i = (*game).player.i + i;
	(*game).player.j = (*game).player.j + j;
	(*game).P_img = xpm;
}
